  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        `${BaseUrl}/users/auth/password/forgot`,
        data
      );
  ...
  return (
    <PageContainer>
      ...
      <ScrollView style={tw``}>
        ...
        >
          <View style={tw` mb-10`}>
            <Header size={21}>Reset your Password</Header>
            ...
            <View style={tw`mt-4`}>
              <TextPrimary
                ...
                lineHeight={19.93}
              >
                Enter your email address and we would send you a code to reset your password.
              </TextPrimary>
            </View>
          </View>
